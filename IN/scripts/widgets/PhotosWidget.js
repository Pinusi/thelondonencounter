...
if( !THELONDONENCOUNTER.Widgets ) { THELONDONENCOUNTER.Widgets = {}; }

THELONDONENCOUNTER.Widgets.Photos = function( container )
{
	this.superSized();
};
 ...
 */
 $(function()
 {
 	var WIDGET_NAME = 'photos_widget',
 	CONSTRUCTOR = THELONDONENCOUNTER.Widgets.Photos;

 	$.each( $('[data-widget="' + WIDGET_NAME + '"]'), function()
 	{
 		window.TLE.WidgetController.initialise( $(this), CONSTRUCTOR );
 	} );
 } );
